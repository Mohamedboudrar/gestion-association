...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => "La valeur saisie pour :attribute apparaît dans une fuite de données connue. Veuillez choisir un(e) autre :attribute.",
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Swaps the raw field name (e.g. "email") shown in every message above
    | for a natural-sounding French label (e.g. "adresse e-mail"), across
    | every FormRequest in the app — no per-request messages() overrides
    ...
    */
    ...
    'attributes' => [
        ...
        'rejection_type' => 'type de rejet',
        'supplier_name' => 'nom du fournisseur',
        'invoice_number' => 'numéro de facture',
        'invoice_path' => 'fichier de la facture',
        ...
        'latitude' => 'latitude',
        'longitude' => 'longitude',
        'to_phase' => 'phase cible',
        'summary' => 'résumé',
        'proofs' => 'pièces justificatives',
        'reason' => 'motif',
        'role' => 'rôle',
        'committee_role' => 'rôle dans le comité',
        'new_member_id' => 'nouveau membre',
        'allocation_date' => "date d'allocation",
        'proof_file' => 'fichier justificatif',
        'association_name' => "nom de l'association",
        'website' => 'site web',
        'annual_subscription_amount' => 'montant de la cotisation annuelle',
        'currency' => 'devise',
        'logo' => 'logo',
        'due_id' => 'cotisation annuelle',
